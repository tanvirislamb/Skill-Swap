...
export default function Details() {
    ...
    return (
        <div className="max-w-7xl mx-auto my-20 flex justify-center items-center bg-white/60 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden border border-teal-600">
